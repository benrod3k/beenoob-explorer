...
import beenoobLogo_b from "./logo_b.png";
import beenoobLogo_w from "./logo_w.png";
          ...
          <Toolbar>
            ...
            >
                  ...
                  <Grid container>
                    <Grid>
                      <img
                        ...
                        src= {darkMode.value ? beenoobLogo_w : beenoobLogo_b}
                      />
                    </Grid>
                  </Grid>
                </Link>
              ...
              <Grid item>
                ...
                <Tooltip title={t("Beenoob Github") as string}>
                  <IconButton
                    onClick={() =>
                      window.open("https://github.com/beenoob-protocol")
                    }
                  >
                    <CodeIcon />
                  </IconButton>
